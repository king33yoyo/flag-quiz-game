...
- 🌐 **双语支持** - 中文和英文界面切换
- 📱 **完美移动端适配** - 全面的移动端优化，包括垂直按钮、响应式布局和动态背景限制
- 🎨 **地理主题背景** - 使用CSS创建的世界地图风格背景效果，动态适配屏幕大小
- 🛡️ **错误边界** - 优雅的错误处理，防止游戏崩溃
- ⏱️ **实时倒计时** - 限时挑战模式完整的倒计时功能
- 🔊 **音效反馈** - 答题正确/错误和倒计时音效
- 🎨 **优雅UI** - 改进的分数显示布局，移动端响应式设计和优化的弹窗适配
...
### v1.3.0 (2024-01-XX)
- 🗑️ **移除排行榜功能** - 简化游戏体验，专注于核心玩法
- 🎨 **清理界面文字** - 移除各模式上方的文字内容，提升视觉效果
- 🏆 **简化游戏结束界面** - 移除高分记录和名称输入功能
- ⚡ **优化性能** - 减少不必要的组件和数据存储
- 🎯 **聚焦核心体验** - 提供更纯粹的学习和娱乐体验
